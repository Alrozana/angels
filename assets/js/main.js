...
(function() {
    ...
    tmPk.smoothScrollNavigation = function() {
        // Desktop menu smooth scroll
        $('.parent-nav a[href^="#"]').on('click', function(e) {
            e.preventDefault();
        ...
        $('.mainmenu a[href^="#"]').on('click', function(e) {
            ...
            if (target.length) {
                ...
                $('#side-hide').removeClass('side-collups-show');
            }
        });

        // Footer links smooth scroll
        $('.ft-link a[href^="#"]').on('click', function(e) {
            e.preventDefault();
            var target = $(this.hash);
            if (target.length) {
                $('html, body').animate({
